...
urlpatterns = [
    ...
    path('breeds/<slug:breed_slug>/', views.breed_profile ,name='breed_profile'),             # Requires dynamic slug field
    path('breeds/<slug:breed_slug>/<slug:dog_slug>/', views.dog_profile ,name='dog_profile'),        # Requires dynamic slug field
